...
# We need to add the project root (parent of 'ui') to sys.path
# so that absolute imports like 'from src.config import ...' work correctly.
...
from src.embeddings import VectorStoreManager # Note: VectorStoreManager is imported but not used directly in the UI
